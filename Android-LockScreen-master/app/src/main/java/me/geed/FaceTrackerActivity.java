...
/**
 * Created by Shubham Bhama on 2017-11-22.
 */
...
import me.geed.lockscreen.LockScreenActivity;
import me.geed.lockscreen.LockScreenService;
...
public final class FaceTrackerActivity extends Activity {
    ...
    private void getLauncherPackageName(Context context) {
        ...
        @SuppressLint("WrongConstant") List<ResolveInfo> resInfoList = context.getPackageManager().queryIntentActivities(intent, PackageManager.GET_ACTIVITIES);
        if (resInfoList != null) {
            ResolveInfo resInfo;
